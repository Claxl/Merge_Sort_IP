...
module merge_sort_merge_sort_iterative_2_Pipeline_merge (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [7:0] right_stream_1_dout;
input   right_stream_1_empty_n;
output   right_stream_1_read;
...
reg    right_stream_1_blk_n;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] or_ln19_fu_179_p2;
reg   [7:0] left_val_4_reg_221;
reg   [7:0] right_val_4_reg_226;
...
always @ (posedge ap_clk) begin
    if (((tmp_2_nbreadreq_fu_42_p3 == 1'd0) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        left_empty_1_reg_99 <= 1'd1;
    end else if ((((tmp_2_nbreadreq_fu_42_p3 == 1'd1) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_3_nbreadreq_fu_56_p3 == 1'd0) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        right_empty_1_reg_114 <= 1'd1;
    end else if ((((tmp_3_nbreadreq_fu_56_p3 == 1'd1) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_2_nbreadreq_fu_42_p3 == 1'd1) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        left_val_fu_34 <= left_stream_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_3_nbreadreq_fu_56_p3 == 1'd1) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_2_nbreadreq_fu_42_p3 == 1'd0) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1))) begin
        ap_phi_mux_left_empty_1_phi_fu_102_p6 = 1'd1;
    end else if (((ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd0) | ((tmp_2_nbreadreq_fu_42_p3 == 1'd1) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1)))) begin
...
always @ (*) begin
    if (((tmp_3_nbreadreq_fu_56_p3 == 1'd0) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1))) begin
        ap_phi_mux_right_empty_1_phi_fu_117_p6 = 1'd1;
    end else if (((ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd0) | ((tmp_3_nbreadreq_fu_56_p3 == 1'd1) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1)))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = (((ap_predicate_op26_read_state1 == 1'b1) & (right_stream_1_empty_n == 1'b0)) | ((ap_predicate_op19_read_state1 == 1'b1) & (left_stream_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op19_read_state1 = ((tmp_2_nbreadreq_fu_42_p3 == 1'd1) & (ap_phi_mux_left_empty_phi_fu_80_p4 == 1'd1));
end

always @ (*) begin
    ap_predicate_op26_read_state1 = ((tmp_3_nbreadreq_fu_56_p3 == 1'd1) & (ap_phi_mux_right_empty_phi_fu_91_p4 == 1'd1));
end
...
assign tmp_2_nbreadreq_fu_42_p3 = left_stream_empty_n;

assign tmp_3_nbreadreq_fu_56_p3 = right_stream_1_empty_n;

endmodule //merge_sort_merge_sort_iterative_2_Pipeline_merge
