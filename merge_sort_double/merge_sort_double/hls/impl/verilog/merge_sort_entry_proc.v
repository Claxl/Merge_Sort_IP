...
input  [3:0] output_r_c_num_data_valid;
input  [3:0] output_r_c_fifo_cap;
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (output_r_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
endmodule //merge_sort_entry_proc
