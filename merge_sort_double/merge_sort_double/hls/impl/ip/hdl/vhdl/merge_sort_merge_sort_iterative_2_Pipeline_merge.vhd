...
entity merge_sort_merge_sort_iterative_2_Pipeline_merge is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    right_stream_1_dout : IN STD_LOGIC_VECTOR (7 downto 0);
    right_stream_1_empty_n : IN STD_LOGIC;
    right_stream_1_read : OUT STD_LOGIC;
...
architecture behav of merge_sort_merge_sort_iterative_2_Pipeline_merge is 
...
attribute shreg_extract : string;
    ...
    signal tmp_2_nbreadreq_fu_42_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op19_read_state1 : BOOLEAN;
    signal ap_phi_mux_right_empty_phi_fu_91_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_nbreadreq_fu_56_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal left_val_4_reg_221 : STD_LOGIC_VECTOR (7 downto 0);
    signal right_val_4_reg_226 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_0) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                left_empty_1_reg_99 <= ap_const_lv1_1;
            elsif ((((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_1) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_0) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                right_empty_1_reg_114 <= ap_const_lv1_1;
            elsif ((((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_1) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                left_val_4_reg_221 <= left_val_fu_34;
                ...
                right_val_4_reg_226 <= right_val_fu_38;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_1) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_1) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                right_val_fu_38 <= right_stream_1_dout;
            end if;
        end if;
    end process;
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(left_stream_empty_n, ap_predicate_op19_read_state1, right_stream_1_empty_n, ap_predicate_op26_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= (((ap_predicate_op26_read_state1 = ap_const_boolean_1) and (right_stream_1_empty_n = ap_const_logic_0)) or ((ap_predicate_op19_read_state1 = ap_const_boolean_1) and (left_stream_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_phi_mux_left_empty_1_phi_fu_102_p6_assign_proc : process(ap_phi_mux_left_empty_phi_fu_80_p4, tmp_2_nbreadreq_fu_42_p3, ap_phi_reg_pp0_iter0_left_empty_1_reg_99)
    begin
        if (((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_0) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1))) then 
            ap_phi_mux_left_empty_1_phi_fu_102_p6 <= ap_const_lv1_1;
        elsif (((ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_0) or ((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_1) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1)))) then 
    ...
    ap_phi_mux_right_empty_1_phi_fu_117_p6_assign_proc : process(ap_phi_mux_right_empty_phi_fu_91_p4, tmp_3_nbreadreq_fu_56_p3, ap_phi_reg_pp0_iter0_right_empty_1_reg_114)
    begin
        if (((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_0) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1))) then 
            ap_phi_mux_right_empty_1_phi_fu_117_p6 <= ap_const_lv1_1;
        elsif (((ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_0) or ((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_1) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1)))) then 
    ...
    ap_predicate_op19_read_state1_assign_proc : process(ap_phi_mux_left_empty_phi_fu_80_p4, tmp_2_nbreadreq_fu_42_p3)
    begin
                ap_predicate_op19_read_state1 <= ((tmp_2_nbreadreq_fu_42_p3 = ap_const_lv1_1) and (ap_phi_mux_left_empty_phi_fu_80_p4 = ap_const_lv1_1));
    end process;


    ap_predicate_op26_read_state1_assign_proc : process(ap_phi_mux_right_empty_phi_fu_91_p4, tmp_3_nbreadreq_fu_56_p3)
    begin
                ap_predicate_op26_read_state1 <= ((tmp_3_nbreadreq_fu_56_p3 = ap_const_lv1_1) and (ap_phi_mux_right_empty_phi_fu_91_p4 = ap_const_lv1_1));
    end process;
    ...
    right_stream_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, right_stream_1_empty_n, ap_predicate_op26_read_state1, ap_block_pp0_stage0, ap_start_int)
    begin
        if (((ap_predicate_op26_read_state1 = ap_const_boolean_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            right_stream_1_blk_n <= right_stream_1_empty_n;
        else 
    ...
    right_stream_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op26_read_state1, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_predicate_op26_read_state1 = ap_const_boolean_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            right_stream_1_read <= ap_const_logic_1;
        else 
            right_stream_1_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    temp_stream_din_assign_proc : process(ap_enable_reg_pp0_iter2, ap_predicate_op45_write_state3, ap_predicate_op46_write_state3, left_empty_1_reg_99_pp0_iter1_reg, ap_predicate_op48_write_state3, left_val_4_reg_221, right_val_4_reg_226, ap_block_pp0_stage0_01001)
    begin
        if ((((ap_predicate_op48_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001)) or ((ap_predicate_op46_write_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001)))) then 
            temp_stream_din <= right_val_4_reg_226;
            ...
            temp_stream_din <= left_val_4_reg_221;
        else 
    ...
    tmp_2_nbreadreq_fu_42_p3 <= (0=>(left_stream_empty_n), others=>'-');
    tmp_3_nbreadreq_fu_56_p3 <= (0=>(right_stream_1_empty_n), others=>'-');
end behav;
