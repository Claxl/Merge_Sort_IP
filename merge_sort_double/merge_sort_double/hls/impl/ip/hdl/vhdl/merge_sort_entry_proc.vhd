...
entity merge_sort_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of merge_sort_entry_proc is 
...
begin
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, output_r_c_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (output_r_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
