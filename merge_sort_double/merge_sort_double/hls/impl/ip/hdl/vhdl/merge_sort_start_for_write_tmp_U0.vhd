...
entity merge_sort_start_for_write_tmp_U0 is 
    generic (
...
architecture rtl of merge_sort_start_for_write_tmp_U0 is

    component merge_sort_start_for_write_tmp_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_merge_sort_start_for_write_tmp_U0_ShiftReg : merge_sort_start_for_write_tmp_U0_ShiftReg
    generic map (
...
entity merge_sort_start_for_write_tmp_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end merge_sort_start_for_write_tmp_U0_ShiftReg;

architecture rtl of merge_sort_start_for_write_tmp_U0_ShiftReg is
