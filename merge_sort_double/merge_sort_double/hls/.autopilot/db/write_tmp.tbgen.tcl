...
set C_modelName {write_tmp}
set C_modelType { void 0 }
set C_modelArgList {
	{ tmp_right int 8 regular {fifo 0 volatile }  }
	{ tmp_left int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "tmp_right", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_left", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_left_dout sc_in sc_lv 8 signal 1 } 
	{ tmp_left_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ tmp_left_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ tmp_left_empty_n sc_in sc_logic 1 signal 1 } 
	{ tmp_left_read sc_out sc_logic 1 signal 1 } 
	{ tmp_din sc_out sc_lv 8 signal 2 } 
	{ tmp_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ tmp_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ tmp_full_n sc_in sc_logic 1 signal 2 } 
	{ tmp_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_left_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "tmp_left", "role": "dout" }} , 
 	...
 	{ "name": "tmp_left_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tmp_left", "role": "empty_n" }} , 
 	{ "name": "tmp_left_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tmp_left", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "tmp_right", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_write_tmp_Pipeline_VITIS_LOOP_113_2_fu_30", "Port" : "tmp_right", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "tmp_left", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_tmp_Pipeline_VITIS_LOOP_108_1_fu_22", "Port" : "tmp_left", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "tmp", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_write_tmp_Pipeline_VITIS_LOOP_113_2_fu_30", "Port" : "tmp", "Inst_start_state" : "4", "Inst_end_state" : "5"},
					{"ID" : "1", "SubInstance" : "grp_write_tmp_Pipeline_VITIS_LOOP_108_1_fu_22", "Port" : "tmp", "Inst_start_state" : "1", "Inst_end_state" : "2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_tmp_Pipeline_VITIS_LOOP_108_1_fu_22", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "write_tmp_Pipeline_VITIS_LOOP_108_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "tmp_left", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_tmp_Pipeline_VITIS_LOOP_108_1_fu_22.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_tmp_Pipeline_VITIS_LOOP_113_2_fu_30", "Parent" : "0", "Child" : ["4"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_113_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_tmp_Pipeline_VITIS_LOOP_113_2_fu_30.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}


set ArgLastReadFirstWriteLatency {
	write_tmp {
		tmp_right {Type I LastRead 1 FirstWrite -1}
		tmp_left {Type I LastRead 1 FirstWrite -1}
		tmp {Type O LastRead -1 FirstWrite 1}}
	write_tmp_Pipeline_VITIS_LOOP_108_1 {
		tmp_left {Type I LastRead 1 FirstWrite -1}
		tmp {Type O LastRead -1 FirstWrite 1}}
...
set Spec2ImplPortList { 
	...
	tmp_left { ap_fifo {  { tmp_left_dout fifo_data_in 0 8 }  { tmp_left_num_data_valid fifo_status_num_data_valid 0 3 }  { tmp_left_fifo_cap fifo_update 0 3 }  { tmp_left_empty_n fifo_status 0 1 }  { tmp_left_read fifo_port_we 1 1 } } }
