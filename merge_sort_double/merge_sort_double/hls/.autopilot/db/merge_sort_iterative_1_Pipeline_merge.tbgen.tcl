set moduleName merge_sort_iterative_1_Pipeline_merge
set isTopModule 0
...
set C_modelName {merge_sort_iterative.1_Pipeline_merge}
set C_modelType { void 0 }
set C_modelArgList {
	{ temp_stream int 8 regular {fifo 1 volatile }  }
	{ left_stream_1 int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "temp_stream", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "left_stream_1", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ left_stream_1_dout sc_in sc_lv 8 signal 1 } 
	{ left_stream_1_empty_n sc_in sc_logic 1 signal 1 } 
	{ left_stream_1_read sc_out sc_logic 1 signal 1 } 
	{ right_stream_dout sc_in sc_lv 8 signal 2 } 
	{ right_stream_empty_n sc_in sc_logic 1 signal 2 } 
	{ right_stream_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "left_stream_1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "left_stream_1", "role": "dout" }} , 
 	{ "name": "left_stream_1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "left_stream_1", "role": "empty_n" }} , 
 	{ "name": "left_stream_1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "left_stream_1", "role": "read" }} , 
...
set Spec2ImplPortList { 
	...
	left_stream_1 { ap_fifo {  { left_stream_1_dout fifo_data_in 0 8 }  { left_stream_1_empty_n fifo_status 0 1 }  { left_stream_1_read fifo_port_we 1 1 } } }
	right_stream { ap_fifo {  { right_stream_dout fifo_data_in 0 8 }  { right_stream_empty_n fifo_status 0 1 }  { right_stream_read fifo_port_we 1 1 } } }
}
