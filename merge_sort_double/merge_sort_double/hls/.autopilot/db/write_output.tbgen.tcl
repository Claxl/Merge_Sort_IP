...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ output_r_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ output_r_fifo_cap sc_in sc_lv 4 signal 1 } 
	...
	{ output_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ output_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "6", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "output_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_dout fifo_data_in 0 64 }  { output_r_num_data_valid fifo_status_num_data_valid 0 4 }  { output_r_fifo_cap fifo_update 0 4 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_port_we 1 1 } } }
	output_stream { ap_fifo {  { output_stream_dout fifo_data_in 0 8 }  { output_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { output_stream_fifo_cap fifo_update 0 3 }  { output_stream_empty_n fifo_status 0 1 }  { output_stream_read fifo_port_we 1 1 } } }
}
