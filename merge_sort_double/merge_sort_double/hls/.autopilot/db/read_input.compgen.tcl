...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { left_stream_din { O 8 vector } left_stream_num_data_valid { I 3 vector } left_stream_fifo_cap { I 3 vector } left_stream_full_n { I 1 bit } left_stream_write { O 1 bit } } \
} "
}
