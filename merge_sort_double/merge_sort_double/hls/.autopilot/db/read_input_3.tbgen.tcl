...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "right_r","offset": { "type": "dynamic","port_name": "right_r","bundle": "control"},"direction": "READONLY"}]}]} , 
...
set portList { 
	...
	{ right_stream_din sc_out sc_lv 8 signal 2 } 
	{ right_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ right_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ right_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ right_stream_write sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "right_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	read_input_3 {
		...
		right_stream {Type O LastRead -1 FirstWrite 10}}}
...
set Spec2ImplPortList { 
	...
	right_stream { ap_fifo {  { right_stream_din fifo_data_in 1 8 }  { right_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { right_stream_fifo_cap fifo_update 0 3 }  { right_stream_full_n fifo_status 0 1 }  { right_stream_write fifo_port_we 1 1 } } }
}
