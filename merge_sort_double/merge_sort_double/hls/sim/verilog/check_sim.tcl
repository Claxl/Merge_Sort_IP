...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.merge_sort.autotvin_gmem1.dat"
         "c.merge_sort.autotvin_gmem2.dat"
         "c.merge_sort.autotvin_left_r.dat"
         "c.merge_sort.autotvin_right_r.dat"
         "c.merge_sort.autotvin_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.merge_sort.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
