...
`define AUTOTB_DUT      merge_sort
`define AUTOTB_DUT_INST AESL_inst_merge_sort
`define AUTOTB_TOP      apatb_merge_sort_top
`define AUTOTB_LAT_RESULT_FILE "merge_sort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "merge_sort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_merge_sort_top
...
`define AESL_DEPTH_left_r 1
`define AESL_DEPTH_right_r 1
...
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvin_gmem2.dat"
`define AUTOTB_TVIN_left_r_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvin_left_r.dat"
`define AUTOTB_TVIN_right_r_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvin_right_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvin_output_r.dat"
`define AUTOTB_TVOUT_gmem0  "../tv/cdatafile/c.merge_sort.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "../tv/rtldatafile/rtl.merge_sort.autotvout_gmem0.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_gmem1 = 512;
parameter LENGTH_gmem2 = 512;
parameter LENGTH_left_r = 1;
parameter LENGTH_output_r = 1;
parameter LENGTH_right_r = 1;
...
reg end_left_r;
reg [31:0] size_left_r;
reg [31:0] size_left_r_backup;
reg end_right_r;
reg [31:0] size_right_r;
reg [31:0] size_right_r_backup;
reg end_output_r;
