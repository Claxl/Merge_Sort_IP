...
void XMerge_sort_Set_left_r(XMerge_sort *InstancePtr, u64 Data) {
    ...
    XMerge_sort_WriteReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_LEFT_R_DATA, (u32)(Data));
    XMerge_sort_WriteReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_LEFT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMerge_sort_Get_left_r(XMerge_sort *InstancePtr) {
    ...
    Data = XMerge_sort_ReadReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_LEFT_R_DATA);
    Data += (u64)XMerge_sort_ReadReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_LEFT_R_DATA + 4) << 32;
    return Data;
}
...
void XMerge_sort_Set_right_r(XMerge_sort *InstancePtr, u64 Data) {
    ...
    XMerge_sort_WriteReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_RIGHT_R_DATA, (u32)(Data));
    XMerge_sort_WriteReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_RIGHT_R_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMerge_sort_Get_right_r(XMerge_sort *InstancePtr) {
    ...
    Data = XMerge_sort_ReadReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_RIGHT_R_DATA);
    Data += (u64)XMerge_sort_ReadReg(InstancePtr->Control_BaseAddress, XMERGE_SORT_CONTROL_ADDR_RIGHT_R_DATA + 4) << 32;
    return Data;
}
