...
using hls::sim::Byte;
extern "C" void merge_sort(Byte<1>*, int, int);
extern "C" void apatb_merge_sort_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_offset_byte_param_output_r = 1024*1;
  // DUT call
  merge_sort(__xlx_input_r_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r);
// print __xlx_apatb_param_input_r
for (size_t i = 0; i < __xlx_size_param_input_r; ++i) {
((Byte<1>*)__xlx_apatb_param_input_r)[i] = __xlx_input_r_output_r__tmp_vec[__xlx_offset_param_input_r+i];
}
// print __xlx_apatb_param_output_r
for (size_t i = 0; i < __xlx_size_param_output_r; ++i) {
((Byte<1>*)__xlx_apatb_param_output_r)[i] = __xlx_input_r_output_r__tmp_vec[__xlx_offset_param_output_r+i];
}
}
