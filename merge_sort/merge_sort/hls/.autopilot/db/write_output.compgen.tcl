...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_stream_dout { I 8 vector } output_stream_num_data_valid { I 3 vector } output_stream_fifo_cap { I 3 vector } output_stream_empty_n { I 1 bit } output_stream_read { O 1 bit } } \
} "
}
...
set InstName merge_sort_flow_control_loop_pipe_U
set CompName merge_sort_flow_control_loop_pipe
