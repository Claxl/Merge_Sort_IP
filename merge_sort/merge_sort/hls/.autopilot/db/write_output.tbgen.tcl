...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_dout fifo_data_in 0 64 }  { output_r_num_data_valid fifo_status_num_data_valid 0 3 }  { output_r_fifo_cap fifo_update 0 3 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_port_we 1 1 } } }
