...
set portList { 
	...
	{ output_r_c_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ output_r_c_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_r_c", "role": "num_data_valid" }} , 
 	{ "name": "output_r_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "output_r_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "output_r_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	output_r_c { ap_fifo {  { output_r_c_din fifo_data_in 1 64 }  { output_r_c_num_data_valid fifo_status_num_data_valid 0 3 }  { output_r_c_fifo_cap fifo_update 0 3 }  { output_r_c_full_n fifo_status 0 1 }  { output_r_c_write fifo_port_we 1 1 } } }
}
