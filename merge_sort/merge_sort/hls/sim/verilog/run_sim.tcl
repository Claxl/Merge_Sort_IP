...
if {[file isfile merge_sort.autotvin.dat]} {
	file delete -force merge_sort.autotvin.dat
}

if {[file isfile merge_sort.autotvout.dat]} {
	file delete -force merge_sort.autotvout.dat
}
