...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.merge_sort.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.merge_sort.autotvout_gmem.dat"
...
parameter gmem_transaction_depth = 32'd 2048;
parameter gmem_mem_depth = 32'd 512;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/claxl/Documents/NECSTCamp/merge_sort/merge_sort/hls/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/claxl/Documents/NECSTCamp/merge_sort/merge_sort/hls/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
