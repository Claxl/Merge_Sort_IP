...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "merge_sort.autotvin.dat"
	set constFileTvOut       "merge_sort.autotvout.dat"
	set constFileHdlTvIn     "merge_sort.autohdltvin.dat"
	set constFileHdlTvOut    "merge_sort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
